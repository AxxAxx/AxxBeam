...
#define FLASH_USER_HEALTH_ADDR   ((uint32_t)ADDR_FLASH_PAGE_60)   /* Health log (hours, records, counters) */
#define FLASH_USER_FIRST_START_ADDR   ((uint32_t)ADDR_FLASH_PAGE_61)   /* Start @ of user Flash area */
